...
const int q=4;
#define simd_comp_block(y,i) (simd_comp(y,i)+(simd_comp(y,(i)+4)<<4)+(simd_comp(y,(i)+8)<<8)+(simd_comp(y,(i)+12)<<12))
#define si_block(i) (si[i]+(si[(i)+4]<<4)+(si[(i)+8]<<8)+(si[(i)+12]<<12))
#else
inline int simd_comp(dtype *y, int i){
	__m128i am = _mm_loadu_si128((__m128i *)(y+i));
	__m128i bm = _mm_loadu_si128((__m128i *)(y+i+1));
//	__m128i am = _mm_set_epi8(y[i+15],y[i+14],y[i+13],y[i+12],y[i+11],y[i+10],y[i+9],y[i+8],y[i+7],y[i+6],y[i+5],y[i+4],y[i+3],y[i+2],y[i+1],y[i]);
//	__m128i bm = _mm_set_epi8(y[i+16],y[i+15],y[i+14],y[i+13],y[i+12],y[i+11],y[i+10],y[i+9],y[i+8],y[i+7],y[i+6],y[i+5],y[i+4],y[i+3],y[i+2],y[i+1]);
